...
import co.edu.ul.wichitoco.controller.util.JsfUtil;
import co.edu.ul.wichitoco.facade.AbstractFacade;
import co.edu.ul.wichitoco.facade.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    private Locale localization = new Locale("es", "CO");
    ...
    public List<T> completeMethod(final String text) {
        if (this.completeList == null) {
            this.completeList = this.ejbFacade.findAll();
        }
        return this.<T>filtrar(this.completeList, text);
    }

    public <E> List<E> filtrar(List<E> tempList, String query) {
        if (tempList == null) {
            return null;
        }
        List<E> filteredList = new ArrayList<>();
        for (E object : tempList) {
            if (object.toString().toLowerCase(this.localization).contains(query.toLowerCase(this.localization))) {
