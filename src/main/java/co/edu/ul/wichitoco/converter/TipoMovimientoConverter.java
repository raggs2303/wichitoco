...
import co.edu.ul.wichitoco.facade.TipoMovimientoFacade;
...
public class TipoMovimientoConverter extends AbstractConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        return  super.getFacade(TipoMovimientoFacade.class).find(getKey(value));
    }
