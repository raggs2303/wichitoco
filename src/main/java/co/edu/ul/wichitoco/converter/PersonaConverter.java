...
import co.edu.ul.wichitoco.facade.PersonaFacade;
...
public class PersonaConverter extends AbstractConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        return  super.getFacade(PersonaFacade.class).find(getKey(value));
    }
