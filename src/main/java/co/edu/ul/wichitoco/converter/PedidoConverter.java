...
import co.edu.ul.wichitoco.facade.PedidoFacade;
...
public class PedidoConverter extends AbstractConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        return  super.getFacade(PedidoFacade.class).find(getKey(value));
    }
